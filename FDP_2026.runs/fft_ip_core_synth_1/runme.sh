...
HD_PWD='C:/Users/limke/Desktop/2026 project/FDP/FDP_2026.runs/fft_ip_core_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fft_ip_core.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fft_ip_core.tcl
